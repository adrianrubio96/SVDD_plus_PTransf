...
gpurun python main_iter.py 4tops ftops_Transformer ../log/DarkMachines $h5_file $yaml_config --objective one-class --lr 0.0001 --n_epochs 2 --lr_milestone 50 --batch_size 500 --weight_decay 0.5e-6 --pretrain False 
cd $dir